...
It uses [Weberknecht](http://code.google.com/p/weberknecht/ (this has been removed to github), corrected: https://github.com/bright60/weberknecht ) as transport backend, but it's easy
