...
It uses [Weberknecht](https://github.com/bright60/weberknech ) ( http://code.google.com/p/weberknecht/ (this has been removed to github), corrected: https://github.com/bright60/weberknech )as transport backend, but it's easy
